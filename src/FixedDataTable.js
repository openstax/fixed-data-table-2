...
var FixedDataTable = createReactClass({
  ...
  propTypes: {
     ...
     * inset scrollbar
     */
    insetScrollbarX: PropTypes.bool,
    insetScrollbarY: PropTypes.bool,
  ...
  render() /*object*/ {
    ...
    if (showScrollbarX) {
      var scrollbarXWidth = state.width - state.fixedBufferWidth - Scrollbar.SIZE;
      horizontalScrollbar =
        <HorizontalScrollbar
  ...
  _calculateState(/*object*/ props, /*?object*/ oldState) /*object*/ {
    ...
    var calcFixed = function(component) {
